...
def _qualification_metrics(state: QualificationState) -> dict[str, object]:
    ...
    return {
        ...
        "schwabMarketDataSuccessCount": metrics.schwab_market_data_successes,
        "candleReadinessSuccessCount": metrics.candle_readiness_successes,
        "lastSuccessfulSchwabRead": metrics.last_successful_schwab_read,
        "schwabAuthHealth": dict(metrics.auth_health),
