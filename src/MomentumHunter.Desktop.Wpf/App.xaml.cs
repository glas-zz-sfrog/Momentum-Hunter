...
public partial class App : System.Windows.Application
{
    ...
    private async void OnStartup(object sender, StartupEventArgs e)
    {
        ...
        services.AddSingleton<ISimulationWorkspaceClient>(serviceProvider =>
        ...
        services.AddSingleton<ITechnicalResearchWorkspaceClient>(serviceProvider =>
            new PythonTechnicalResearchWorkspaceClient(serviceProvider.GetRequiredService<IPythonEngineHostConnection>()));
        services.AddSingleton<ISavedWatchlistWorkspaceClient>(serviceProvider =>
        ...
        services.AddSingleton<IResearchMaturityWorkspaceClient>(serviceProvider =>
            new PythonResearchMaturityWorkspaceClient(
                serviceProvider.GetRequiredService<IPythonEngineHostConnection>()));
        ...
        services.AddSingleton<ShellViewModel>(serviceProvider => new ShellViewModel(
            ...
            serviceProvider.GetRequiredService<IResearchMaturityWorkspaceClient>()));
