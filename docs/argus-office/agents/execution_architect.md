...
- Produce implementation slices that avoid protected areas until approved.

## Artifact-First Work
Create execution architecture notes, mode-boundary maps, adapter contracts, ADRs, and implementation-slice handoffs. Do not stop at broad architecture advice.
