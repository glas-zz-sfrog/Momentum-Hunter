...
SHADOW-015/016/017 and CANARY-001/002/003/004/005/006/007/008/009/010/011/012/013 are proven, remotely backed
...
| --- | --- | --- | --- | --- | --- | --- |
| `codex/ARGUS-CANARY-014-complete-stack-integrity` | `0aa4933` plus governance closeout | Yes | No | `ACTIVE / IMPLEMENTED_PENDING_MERGE` | Expands the nonauthorizing integration manifest to frozen V2 coverage of CANARY-001 through CANARY-013. Default verification rejects V1 downgrade, arbitrary partial sets, missing successor files, unsafe imports/actions, and widened component exceptions while retaining explicit exact-policy V1 verification. | Preserve remotely until SHADOW-014 releases `master`; regenerate a final-head V2 manifest and run the complete regression suite during later clean integration. Never treat it as provider, runtime-stop, or order authority. |
