...
SHADOW-015/016/017 and CANARY-001/002/003/004/005/006/007/008/009/010/011/012/013/014/015
...
| --- | --- | --- | --- | --- | --- | --- |
| `codex/ARGUS-SCHWAB-004-account-shape-evidence` | `fd75f32` plus governance closeout | Yes after closeout push | No | `ACTIVE / IMPLEMENTED_PENDING_MERGE` | One stacked successor containing SCHWAB-004/004A account evidence plus CANARY-015's write-once broker-worker identity binding. CANARY-015 consumes the persisted CANARY-013 chain and exact release-policy commitments while keeping runtime acknowledgement, provider revocation, physical-stop completion, and all action authority false. Compileall, 16 focused, 90 adjacent CANARY, 421 Schwab, 1,268 full Python, and 216 .NET tests pass. | Preserve remotely. Use the identity contract only when the eventual isolated worker exists; after SHADOW-014 releases `master`, regenerate the final stack manifest including CANARY-015 and integrate only after all release gates pass. |
