...
| Branch | HEAD / base | Pushed | Merged to local master | Classification | Purpose | Next action |
| --- | --- | --- | --- | --- | --- | --- |
| `codex/ARGUS-THINKORSWIM-OVERNIGHT-RTD-001` | Implementation `4b297d6da673a719597b99d3d6954a72a3d85fa7` / exact synchronized base `85e73bebe785c5493cf1983dba68fada0e29cff8` | Yes | No | `IMPLEMENTED_PENDING_PHASE_A_AND_TRUE_OVERNIGHT_EVIDENCE` | Test only the officially supported desktop Excel `tos.rtd` market-data route using a fixed market-only basket and separate durable evidence. | Freeze the final governance head, run post-04:00 Phase A, then preserve all eight true-overnight checkpoints through 04:05 ET. |
