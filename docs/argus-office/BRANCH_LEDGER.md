...
SHADOW-015/016/017 and CANARY-001/002/003/004/005/006/007/008/009/010/011/012 are proven, remotely backed
...
| --- | --- | --- | --- | --- | --- | --- |
| `codex/ARGUS-CANARY-012-readonly-process-observer` | `b45cf81` plus governance closeout | Yes | No | `ACTIVE / IMPLEMENTED_PENDING_MERGE` | Adds a Windows limited-information process observer with creation-time/executable commitment identity, PID-reuse handling, fail-closed unavailable states, and CANARY-005 mapping. It performs no process, credential, network, or broker mutation. | Preserve remotely until SHADOW-014 releases `master`; later bind a target captured from the exact future broker worker and combine it with separately approved provider-revocation evidence in a physical stop drill. |
