...
| `codex/ARGUS-AUTOMATION-RUNTIME-IDENTITY-001` | base `f2c2b65`; implementation commit pending | Pending after commit | No | `IMPLEMENTED_PENDING_PRODUCTION_PROOF` | Approved opening runtime identity, explicit promotion, execution gate, and future-only migration. | Commit/push, create rollback package, then controlled merge and zero-provider production proof. |
