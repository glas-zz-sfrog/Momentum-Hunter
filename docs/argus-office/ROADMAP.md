...
| --- | --- | --- | --- |
| A - Market Data And Monitoring | Schwab Streamer, candles, reconciliation, discovery, monitoring, catalysts. | VALIDATED_PENDING_INTEGRATION / WAITING_EXTERNAL_TIME | Canonical candle stack complete; Tuesday's early/late Schwab after-hours proof is scheduled from frozen feature commit `a69a87b`; MONITOR and CATALYST-002A are validated; CATALYST-002B waits for provider proof. |
