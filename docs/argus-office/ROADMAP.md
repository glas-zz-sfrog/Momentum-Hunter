...
| Active branch | `codex/ARGUS-SHADOW-005-prospective-evidence-handoff` at handoff `27f9411`, plus the verified hard-disabled selector/governance checkpoint. SHADOW-004 is its visual parent at `375da59`; neither branch is merged. |
