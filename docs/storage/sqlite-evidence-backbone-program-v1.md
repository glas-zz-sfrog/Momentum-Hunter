...
| --- | --- | --- | --- | --- |
| 1 | Minute Bars Slice | `minute_bars` | `opportunity-minute-bars.json` | `Add SQLite minute bars slice` |
| 2 | Evidence Runs / Evidence Metrics Slice | `evidence_runs`, `evidence_metrics` | evidence autopilot status, evidence health reports, alert performance summaries, outcome update status | `Add SQLite evidence runs slice` |
...
| `minute_bars` | `momentum_hunter.sqlite_store` | Planned Phase 1 | `opportunity-minute-bars.json` |
| `evidence_runs` | `momentum_hunter.sqlite_store` | Planned Phase 2 | evidence reports/status files |
| `evidence_metrics` | `momentum_hunter.sqlite_store` | Planned Phase 2 | evidence reports/status files |
